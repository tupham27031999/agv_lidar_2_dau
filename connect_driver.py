            ...
            if self.sent_data_driver == 0:
                ...
                if time.time() - self.time_sent > 0.1 and self.time_sent != 0:
                    ...
                    if self.dk_agv_thu_cong == 0:
                        ...
                        # print("kkkkkkkk", v_tien_max,  v_re_max, point_start_LQR, point_end_LQR,
                        #       goc_agv, angle, distance, check_angle_distance,
                        ...
                        if stop == 0:
                            ...
                            # if vt_phai > v_tien_max or vt_trai > v_tien_max: #lỗi chương trình stop_agv
                            if vt_phai > v_tien_max or vt_trai > v_tien_max:
                                print("lỗi chương trình", vt_phai, vt_trai, v_tien_max)
                                vt_phai = 0
                                vt_trai = 0
